...
public class TraxTitleActivityViewRowImpl extends ViewRowImpl {
    ...
    protected void create(AttributeList attributeList) {
        ...
        TraxActivityContentOwnerImpl newActivityContentOwner =
            (TraxActivityContentOwnerImpl)this.getTraxActivityContentOwner();
        try {
            ...
            if (this.getTitleView() != null) {
                if (this.getTitleView().getContentOwnerId() != null) {
                    newActivityContentOwner.create(newActivity);
                    newActivityContentOwner.setActivityId(newActivity.getId());
                    newActivityContentOwner.setContentOwnerId(this.getTitleView().getContentOwnerId());
            ...
            newActivityUser.revert();
            newActivityContentOwner.revert();
            throw new RowCreateException(true, /* EO Row? */"TitleActivity",
