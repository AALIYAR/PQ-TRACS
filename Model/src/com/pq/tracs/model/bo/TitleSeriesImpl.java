...
// ---------------------------------------------------------------------
public class TitleSeriesImpl extends TracsBaseEntity {
    ...
    public enum AttributesEnum {
        Id {
            public Object get(TitleSeriesImpl obj) {
                return obj.getId();
            }

            public void put(TitleSeriesImpl obj, Object value) {
        ...
        public abstract Object get(TitleSeriesImpl object);

        public abstract void put(TitleSeriesImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("com.pq.tracs.model.bo.TitleSeries");
        }
        ...
        super.prepareForDML(operation, e);
         ...
         try {
             if (operation == DML_INSERT || operation == DML_UPDATE) {
                 if(getTitle().getTitleSeries().getRowCount()<=1){
                     setPrimaryFlag("Y");
                 }
             }
         } catch (Exception efg) {
