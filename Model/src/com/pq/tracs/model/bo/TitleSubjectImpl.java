...
// ---------------------------------------------------------------------
public class TitleSubjectImpl extends TracsBaseEntity {
    ...
    public enum AttributesEnum {
        Id {
            public Object get(TitleSubjectImpl obj) {
                return obj.getId();
            }

            public void put(TitleSubjectImpl obj, Object value) {
        ...
        public abstract Object get(TitleSubjectImpl object);

        public abstract void put(TitleSubjectImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("com.pq.tracs.model.bo.TitleSubject");
        }
        ...
        super.prepareForDML(operation, e);
         ...
         try {
             if (operation == DML_INSERT || operation == DML_UPDATE) {
                 if(getTitle().getTitleSubject().getRowCount()<=1){
